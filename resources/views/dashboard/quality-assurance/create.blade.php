<x-dashboard-layout title="Tambah Data Kelompok Penjaminan Mutu">
    <x-slot name="header">
        Tambah Data Kelompok Penjaminan Mutu">
    </x-slot>

    <div class="card p-4">
        <form method="post" action="{{ route('dashboard.quality-assurance.store') }}" enctype="multipart/form-data">
            @csrf
