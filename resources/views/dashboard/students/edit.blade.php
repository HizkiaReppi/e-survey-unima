<x-dashboard-layout title="Edit Data Mahasiswa">
    ...
    <div class="card p-4">
        <form method="POST" action="{{ route('dashboard.students.update', $mahasiswa->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input type="text"
                       ...
                       value="{{ old('fullname', $mahasiswa->fullname) }}"
                       autocomplete="name"
                       autofocus
                       required />
            ...
            <div class="mb-3">
                ...
                <input type="number"
                       ...
                       value="{{ old('batch', $mahasiswa->batch) }}"
                       autocomplete="off"
                       required />
            ...
            <div class="mb-3">
                ...
                <select class="form-select {{ $errors->get('department_id') ? 'border-danger' : '' }}"
                    ...
                    @foreach ($departments as $department)
                        <option value="{{ $department->id }}" {{ old('department_id', $mahasiswa->department_id) == $department->id ? 'selected' : '' }}>
                            {{ $department->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                ...
                <input type="text"
                       ...
                       value="{{ old('phone_number', $mahasiswa->phone_number) }}"
                       autocomplete="tel" />
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control {{ $errors->get('address') ? 'border-danger' : '' }}"
                          ...
                          placeholder="Alamat"
                          rows="2"
                          autocomplete="street-address">{{ old('address', $mahasiswa->address) }}</textarea>
            ...
            <div class="mb-3">
                ...
                <img class="img-preview img-thumbnail rounded mb-2" style="width: 300px; height: auto;" src="{{ old('foto', $mahasiswa->foto) ? asset('storage/' . $mahasiswa->foto) : '' }}">
                <input type="file"
